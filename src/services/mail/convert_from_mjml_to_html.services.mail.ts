...
const sendForgotPasswordMail = readFileSync(resolve(__dirname, './templates/auth/forgot_password.template.mjml')).toString();
...
export const sendForogtPasswordMailTemplate = compile(mjml2html(sendForgotPasswordMail).html);
